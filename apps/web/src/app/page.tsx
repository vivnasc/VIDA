...
const realProblems = [
  "As contas da casa nunca batem \u2014 ningu\u00E9m sabe para onde vai o dinheiro",
  "O calend\u00E1rio da fam\u00EDlia vive em 3 apps diferentes e nenhuma funciona",
  "As vacinas dos filhos est\u00E3o num papel perdido algures em casa",
  "As tarefas dom\u00E9sticas caem sempre na mesma pessoa",
  "Os momentos importantes da fam\u00EDlia ficam espalhados em grupos de WhatsApp",
];

const lifeChanges = [
  "Sabes exactamente quanto gastas, poupas e investes \u2014 sem surpresas ao fim do m\u00EAs",
  "Toda a fam\u00EDlia v\u00EA o mesmo calend\u00E1rio, com lembretes autom\u00E1ticos",
  "O hist\u00F3rico m\u00E9dico de cada membro da fam\u00EDlia est\u00E1 a um toque",
  "As responsabilidades da casa s\u00E3o partilhadas e acompanhadas",
  "As mem\u00F3rias ficam organizadas para sempre \u2014 n\u00E3o se perdem no rolo da c\u00E2mera",
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden sm:flex items-center gap-8">
              ...
              <a href="#problema" className="text-sm text-white/50 hover:text-white transition-colors">
                Porqu&ecirc;
              </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold">
              A vida familiar n&atilde;o devia ser t&atilde;o dif&iacute;cil.
            </h2>
            <p className="mt-4 text-lg text-white/40">
              Todos os dias, fam&iacute;lias perdem tempo, dinheiro e paci&ecirc;ncia com coisas que deviam ser simples.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white/[0.03] rounded-3xl border border-white/10 p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg font-bold text-red-400">A realidade de muitas fam&iacute;lias</h3>
              </div>
            ...
            <div className="bg-white/[0.03] rounded-3xl border border-emerald-500/20 p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg font-bold text-emerald-400">O que muda com o VIDA</h3>
              </div>
              <ul className="space-y-4">
                {lifeChanges.map((s) => (
      ...
      <section className="py-16 sm:py-24 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="mt-4 text-lg text-white/40">
              Do caos &agrave; organiza&ccedil;&atilde;o em 3 passos simples.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Regista-te gr\u00E1tis e acede a todas as 4 apps do ecossistema. Sem cart\u00E3o de cr\u00E9dito.",
              },
              {
                number: "02",
                title: "Convida a fam\u00EDlia",
                description: "Adiciona os membros da tua fam\u00EDlia. Cada um personaliza o seu espa\u00E7o e come\u00E7a a contribuir.",
              },
              {
                number: "03",
                title: "Organiza tudo",
                description: "Finan\u00E7as, calend\u00E1rio, sa\u00FAde e casa \u2014 tudo sincronizado automaticamente entre os m\u00F3dulos.",
              },
            ].map((step, i) => (
              <div key={step.number} className="relative">
                ...
                <div className="bg-white/[0.03] rounded-3xl border border-white/10 p-8 h-full">
                  <div className="text-5xl font-extrabold bg-gradient-to-r from-familia-400 via-dinheiro-400 to-lar-400 bg-clip-text text-transparent mb-4">{step.number}</div>
