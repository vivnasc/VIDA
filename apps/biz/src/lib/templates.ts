...
export const BUSINESS_TEMPLATES: Record<string, TemplateDefinition> = {
  ...
  electronica: {
    id: "electronica",
    name: "Denda de Informática / Telemóveis",
    emoji: "📱",
    description: "Computadores, telemóveis, acessórios e reparações",
    icon: Smartphone,
    color: "bg-blue-600",
    hasAppointments: true,
    hasDelivery: true,
    ...
    services: [
      ...
      { name: "Portátil (novo)", defaultPrice: 25000, costEstimate: 18000 },
      { name: "Portátil (usado)", defaultPrice: 12000, costEstimate: 7500 },
      { name: "Computador desktop", defaultPrice: 20000, costEstimate: 14000 },
      { name: "Tablet", defaultPrice: 10000, costEstimate: 7000 },
      { name: "Impressora", defaultPrice: 8000, costEstimate: 5500 },
      { name: "Tinteiro/Toner", defaultPrice: 1500, costEstimate: 800 },
      { name: "Capinha/Protector", defaultPrice: 200, costEstimate: 50 },
      { name: "Carregador", defaultPrice: 300, costEstimate: 100 },
      { name: "Auriculares/Fones", defaultPrice: 500, costEstimate: 150 },
      { name: "Pen USB / Disco externo", defaultPrice: 1200, costEstimate: 700 },
      ...
      { name: "Formatação/Software", defaultPrice: 800, durationMinutes: 60, costEstimate: 0 },
    ...
    expenseCategories: [
      ...
      { name: "Electricidade", icon: "Zap" },
      { name: "Marketing", icon: "Megaphone" },
      { name: "Transporte mercadoria", icon: "Truck" },
    ],
    stockCategories: [
      { name: "Telemóveis", unit: "un", hasExpiry: false },
      { name: "Computadores/Portáteis", unit: "un", hasExpiry: false },
      { name: "Impressoras", unit: "un", hasExpiry: false },
      { name: "Acessórios", unit: "un", hasExpiry: false },
