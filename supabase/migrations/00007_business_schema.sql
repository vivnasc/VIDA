-- ============================================================================
-- VIDA Ecosystem - Migration 00007: Business Schema Tables (maBIZ)
-- ============================================================================
-- Business management tables for maBIZ:
--   businesses, products, sales, sale_items, cash_registers,
--   customers, customer_debts, fiado_payments, staff_members,
--   staff_commissions, suppliers, purchase_orders,
--   business_expenses, appointments, licenses, equipment,
--   education_modules, education_progress, promotions
...
COMMENT ON TABLE biz_schema.businesses IS 'User businesses/negócios';
...
-- ============================================================================
-- TABLE: products (products & services)
-- ============================================================================
...
COMMENT ON TABLE biz_schema.products IS 'Products and services for a business';
...
COMMENT ON TABLE biz_schema.customers IS 'Business customers';
...
COMMENT ON TABLE biz_schema.staff_members IS 'Business staff/employees';
...
COMMENT ON TABLE biz_schema.sales IS 'Sales/vendas transactions';
...
COMMENT ON TABLE biz_schema.sale_items IS 'Individual items within a sale';
...
COMMENT ON TABLE biz_schema.cash_registers IS 'Daily cash register (caixa diário)';
...
COMMENT ON TABLE biz_schema.customer_debts IS 'Customer debts/fiados';
...
COMMENT ON TABLE biz_schema.fiado_payments IS 'Payments against customer debts';
...
COMMENT ON TABLE biz_schema.staff_commissions IS 'Staff sales commissions';
...
COMMENT ON TABLE biz_schema.suppliers IS 'Business suppliers/fornecedores';
...
COMMENT ON TABLE biz_schema.purchase_orders IS 'Purchase orders to suppliers';
...
COMMENT ON TABLE biz_schema.business_expenses IS 'Business expenses/despesas';
...
COMMENT ON TABLE biz_schema.appointments IS 'Business appointments/marcações';
...
COMMENT ON TABLE biz_schema.licenses IS 'Business licenses and compliance documents';
...
COMMENT ON TABLE biz_schema.equipment IS 'Business equipment and assets';
...
COMMENT ON TABLE biz_schema.promotions IS 'Business promotions and discounts';
...
-- ROW LEVEL SECURITY
-- ============================================================================
-- RLS strategy: user owns businesses, business ownership cascades to child tables.
-- We use a helper function to check business ownership efficiently.
-- ============================================================================
...
-- --------------------------------------------------------------------------
-- Child tables RLS (via business_id ownership check)
-- --------------------------------------------------------------------------
...
-- Customer Debts (via customer -> business)
...
-- Fiado Payments (via debt -> customer -> business)
...
-- Staff Commissions (via staff -> business)
