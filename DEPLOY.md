...
## 1. Criar Projecto Supabase (separado do VIDA)
...
2. Clica **New Query**
3. Cola TODO o conteúdo de `supabase/migrations/00001_business_schema.sql`
4. Clica **Run**
...
```bash
npx supabase login
npx supabase link --project-ref <teu-project-ref>
npx supabase db push
```

## 3. Configurar Variáveis de Ambiente

Cria o ficheiro `.env.local` na raiz do projecto:
```bash
